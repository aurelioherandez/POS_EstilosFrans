                                        ...
                                        <div class="p-3 border border-3 border-warning">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 mb-2">
                                                    ...
                                                    <input readonly type="text" name="impuesto" id="impuesto" class="form-control border-warning">
                                                    @error('impuesto')
                                                    <small class="text-danger">{{ '*'.$message }}</small>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="col-sm-6 mb-2">
                                                    ...
                                                    <input readonly type="date" name="fecha" id="fecha" class="form-control border-warning" value="<?php echo date("Y-m-d") ?>">
                                                    <?php
                                                ...
                                                <div class="col-12 mt-4 text-center">
                                                    <button type="submit" class="btn btn-warning" id="guardar">Realizar compra</button>
                                                </div>
                ...
                if (parseInt(cantidad) > 0 && (cantidad % 1 == 0) && parseFloat(precioCompra) > 0 && parseFloat(precioVenta) > 0) {
                    ...
                    if (parseFloat(precioVenta) > parseFloat(precioCompra)) {
                        ...
                        let fila = '<tr id="fila' + cont + '">' +
                            ...
                            '<td>' + subtotal[cont] + '</td>' +
                            '<td><button class="btn btn-danger" type="button" onClick="eliminarProducto(' + cont + ')">borrar</button></td>' +
                            '</tr>';
